...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("node.broccoli-coin.com", "seed.broccoli-coin.com", true));
        vSeeds.push_back(CDNSSeedData("node2.broccoli-coin.com", "seed2.broccoli-coin.com"));
